...
import com.sjjwn.model.dto.UserAreaDTO;
import com.sjjwn.service.*;
...
import static com.sjjwn.constant.CommonConstant.UNKNOWN;
...
public class AuroraQuartz {
    ...
    public void importSwagger() {
        ...
        List<Integer> resourceIds = resourceService.list().stream().map(com.sjjwn.entity.Resource::getId).collect(Collectors.toList());
